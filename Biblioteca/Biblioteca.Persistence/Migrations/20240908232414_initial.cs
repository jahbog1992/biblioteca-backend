...
namespace Biblioteca.Persistence.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PedidoCabecera",
                schema: "PedidoCabecera",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    FechaPedido = table.Column<DateTime>(type: "date", nullable: false, defaultValueSql: "GETDATE()"),
                    NumeroOperacion = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    Estado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidoCabecera", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PedidoCabecera_Cliente_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PedidoDetalle_Libro_LibroId",
                        column: x => x.LibroId,
                        principalSchema: "Libros",
                        principalTable: "Libro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PedidoDetalle_PedidoCabecera_PedidoId",
                        column: x => x.PedidoId,
                        principalSchema: "PedidoCabecera",
                        principalTable: "PedidoCabecera",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoCabecera_ClienteId",
                schema: "PedidoCabecera",
                table: "PedidoCabecera",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalle_LibroId",
                schema: "PedidoDetalle",
                table: "PedidoDetalle",
                column: "LibroId");
